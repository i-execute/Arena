...
class TestStreamUserscriptProxyFetchStartDelayNoFallback(BaseBridgeTest):
    ...
    async def test_fetch_start_delay_does_not_fallback_to_chrome(self) -> None:
        ...
        with (
            ...
            patch("BRIDGE.main.print"),
            patch("BRIDGE.main.asyncio.sleep", sleep_mock),
            patch("BRIDGE.main.time.time") as time_mock,
            patch("BRIDGE.main.time.monotonic") as mono_mock,
        ):
